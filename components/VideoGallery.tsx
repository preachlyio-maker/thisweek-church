  ...
  return (
    <section>
      ...
      <a
        ...
        style={{ textDecoration: "none", display: "grid", gridTemplateColumns: "1.5fr 1fr", borderTop: "2px solid #1A1A18", borderLeft: "2px solid #1A1A18" }}
      >
        <div className="media-thumb-wrap" style={{ borderRight: "2px solid #1A1A18", borderBottom: "2px solid #1A1A18", aspectRatio: "16 / 9", background: "#1A1A18" }}>
          <Thumb v={feature} />
        </div>
        <div style={{ borderRight: "2px solid #1A1A18", borderBottom: "2px solid #1A1A18", padding: 28, display: "flex", flexDirection: "column", justifyContent: "center", gap: 14 }}>
          ...
          <span className="media-foot font-mono" style={{ fontSize: 10, letterSpacing: "0.12em", textTransform: "uppercase", color: "#8A8578" }}>Watch →</span>
        </div>
      </a>

      {/* Rest */}
      {rest.length > 0 && (
        <div className="trends-3" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", borderLeft: "2px solid #1A1A18" }}>
